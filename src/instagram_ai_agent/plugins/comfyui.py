...
from instagram_ai_agent.core.config import DATA_DIR, NicheConfig
...
async def generate(
    ...
    *,
    ...
    if cfg is not None:
        from instagram_ai_agent.plugins import controlnet as _cn
        from instagram_ai_agent.plugins import lora as _lora
